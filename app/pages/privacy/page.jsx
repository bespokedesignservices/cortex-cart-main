            ...
            <div className="bg-white px-6 py-12 lg:px-8">
                <div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
                    ...
                    <div className="mt-10 max-w-2xl">
                        ...
                        <p className="mt-4">
                           <strong>Website & Analytics Data:</strong> Through our tracking script installed on your website, we collect anonymized and aggregated data about your website visitors, including page views, sales events, device types, geographic locations, and referrers. We do not collect personally identifiable information about your customers.
                        </p>
                         <p className="mt-4">
